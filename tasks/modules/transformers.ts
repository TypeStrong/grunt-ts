...
class BaseImportExportTransformer extends BaseTransformer implements ITransformer {
    ...
    constructor(public key: string, variableSyntax: string, template: (data?: { filename: string; pathToFile: string }) => string, getIndexIfDir: boolean, removeExtensionFromFilePath:boolean) {
